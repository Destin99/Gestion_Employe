                  ...
                  <div class="table-responsive project-stats">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a id ="editId" class="btn btn-info" data-userId = "<c:out value = "${userl.getId() }" />"
								   data-userFonction = "<c:out value = "${userl.getFonction() }" />" 
								   href="#">Edit</a>
								&nbsp;&nbsp;&nbsp;&nbsp;
								
								<c:if test="${userl.isStatut() }">
								<a class="btn btn-danger" href="desactiver?id=<c:out value = "${userl.getId() }" />&adminId=<c:out value = "${user.getId() }" />">Désactiver</a>
								</c:if>
								<c:if test="${userl.isStatut() == false }">
								<a class="btn btn-warning" href="activer?id=<c:out value = "${userl.getId() }" />&adminId=<c:out value = "${user.getId() }" />">Activer</a>
								</c:if>
								
								&nbsp;&nbsp;&nbsp;&nbsp;
								
								<a id ="editId" class="btn btn-info" data-userId = "<c:out value = "${userl.getId() }" />"
								   data-userLogin = "<c:out value = "${userl.getLogin() }" />" data-userPassword = "<c:out value = "${userl.getPwd() }" />"
								   data-userRole = "<c:out value = "${userl.isRole() }" />" href="#">Détail</a>
							</td>
						</tr>
						</c:forEach>
					</tbody>
                                               ...
                                               <tr>
                                                   ...
                                                   <td><c:out value = "${listTache.getResponsable().getNom() }" /></td>
                                                     ...
                                                     <td>
														...
														<c:choose>
							                              <c:when test="${listTache.getStatut() == 'Non Debuter' || listTache.getStatut() == 'Suspendu' }">
